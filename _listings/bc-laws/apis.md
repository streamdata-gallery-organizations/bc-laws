...
- name: BC Laws Describes the documents and directories available within a specific
  ...
  baseURL: https://www.bclaws.ca//civix//content/{aspectId}
  tags: Content,AspectId
  properties:
...
- name: BC Laws A listing of metadata available for the specified aspect and search
  ...
  image: ""
  humanURL: http://bclaws.ca
  baseURL: https://www.bclaws.ca//civix//search/{aspectId}/fullsearch
  tags: Search,AspectId,Fullsearch
  properties:
  - type: x-postman-collection
...
- name: BC Laws
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/bc-laws/master/_listings/bc-laws/openapi.md
x-common:
- type: x-website
  url: http://bclaws.ca
include: []
